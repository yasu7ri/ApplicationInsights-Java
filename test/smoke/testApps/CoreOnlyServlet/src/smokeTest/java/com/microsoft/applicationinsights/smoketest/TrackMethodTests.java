...
public class TrackMethodTests extends AiSmokeTest {

    @Test
    @TargetUri("/trackDependency")
    public void trackDependencySendsRemoteDependencyData() throws Exception {
	...
	public void trackEventSendsEventData_2calls_1withProps() throws Exception {
    ...
    public void trackExceptionSendsExceptionData_3calls_1withProps_1withSev() throws Exception {
    ...
    public void trackHttpRequestAndTrackRequestSendsHttpRequestDataAndRequestData() throws Exception {
        int totalItems = mockedIngestion.getItemCount();
		int expectedItems = 4;
		assertEquals(String.format("There were %d extra telemetry items received.", expectedItems - totalItems),
                expectedItems, totalItems);
    ...
    public void trackMetricSendsMetricData() throws Exception {
	...
	public void trackTraceSendsMessageData_3calls_1withSev_1withProps() throws Exception {
