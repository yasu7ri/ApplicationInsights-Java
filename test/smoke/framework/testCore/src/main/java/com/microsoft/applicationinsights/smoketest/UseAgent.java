 ...
 *
 * <p>The configuration files should be placed in {@code /test/smoke/appServers/global-resources/{mode}_ApplicationInsights.properties}.</p>
 *
 * <p>
 *     The {mode} prefix differentiates the configurations for various purposes and the mode is selected by the
 *     {@link #value()} in this annotation. For example, a configuration file named {@code myconfig_ApplicationInsights.properties}
 ...
 *     and renamed to {@code ApplicationInsights.properties}.
 * </p>
 */
